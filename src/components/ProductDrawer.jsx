...
const ProductDrawer = ({ openDrawer, drawerEdit, products,addProduct }) => {
  const handleCloseDrawerBtn = () => {
    drawerEdit();
  };
  return (
    <div
    ...
    >
      <div className="p-3 flex items-center justify-between">
        ...
        <button
          onClick={handleCloseDrawerBtn}
          id="closeDrawer"
          className="p-3 bg-blue-100 text-blue-600 duration-200 active:scale-95"
        >
          <svg
